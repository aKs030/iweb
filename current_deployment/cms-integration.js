...
class SimpleCMS {
    ...
    renderContent() {
        ...
        this.updateElement('[data-cms="site.description"]', this.content.site?.description);
        
        // Hero section
        this.updateElement('[data-cms="hero.title"]', this.content.hero?.title);
        this.updateElement('[data-cms="hero.subtitle"]', this.content.hero?.subtitle);
        ...
        // Contact
        this.updateAttribute('[data-cms="contact.email"]', 'href', `mailto:${this.content.contact?.email}`);
        this.updateAttribute('[data-cms="contact.linkedin"]', 'href', this.content.contact?.linkedin);
        this.updateAttribute('[data-cms="contact.github"]', 'href', this.content.contact?.github);
    }
    ...
    async saveContent() {
        try {
            ...
            alert('💾 Content gespeichert! (Simulation - echte Implementierung benötigt Backend)');
        } catch (error) {
...
if (window.location.search.includes('cms=true') || 
