import { escapeXml, normalizePath, resolveOrigin, toAbsoluteUrl } from "./api/_xml-utils.js";
import {
  buildSitemapHeaders,
...
const STATIC_PAGE_IMAGES = [
  {
    ...
    caption: "Zentrale Hauptseite mit Portfolio, Blog, Bildern, Videos und Projekten",
  },
  {
    page: "/about/",
    image: FAVICON_512_URL,
    title: "Abdulkerim Sesli",
    caption: "Profilseite mit Hintergrund, Themenfeldern und redaktionellen Inhalten",
  },
  {
    page: "/contact/",
    image: OG_HOME_IMAGE_URL,
  ...
  },
  {
    ...
    title: "Tech Blog",
    caption: "Blog mit Artikeln zu Webentwicklung, SEO, Performance, React und TypeScript",
  },
  {
    page: "/gallery/",
    image: OG_PHOTOGRAPHY_IMAGE_URL,
    title: "Fotografie Portfolio",
    caption: "Bildgalerie mit Portraits, Street-Fotografie und visuellen Serien",
  },
  {
    page: "/videos/",
    image: OG_VIDEOS_IMAGE_URL,
    title: "Videos",
    caption: "Videoseite mit YouTube-Inhalten, Clips, Making-of und Story-Formaten",
  },
  {
    page: "/projekte/",
    image: OG_PROJECTS_IMAGE_URL,
    title: "Code Projekte",
    caption: "Interaktive Webprojekte mit JavaScript, React, UI und Frontend-Experimenten",
  },
];
