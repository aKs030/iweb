...
export const CACHE_CONTROL_PRIVATE_NO_STORE = "no-store, no-cache, must-revalidate, private";
export const CACHE_CONTROL_PROXY_DEFAULT = "public, max-age=300, stale-while-revalidate=86400";
