...
import { matchEdgeCache, storeInEdgeCache } from "./_middleware-utils/edge-cache.js";
import {
...
export async function onRequest(context) {
  ...
  const localHeaderAdjusted = normalizeLocalDevHeaders(initialHeaders, url.hostname);
