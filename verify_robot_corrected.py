...
def verify_robot_loader_corrected():
    with sync_playwright() as p:
        ...
        # Verify interaction model (Container transparent to clicks, Avatar interactive)
        expect(container).to_have_css("pointer-events", "none")
        expect(container.locator(".robot-avatar")).to_have_css("pointer-events", "auto")
