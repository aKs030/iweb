...
- Lokale Utility-CSS (`/pages/gallery/gallery-styles.css`) statt Tailwind-CDN; für produktive Tailwind-Nutzung bitte Tailwind als PostCSS-Plugin oder per Tailwind-CLI einbinden
...
- ✅ CSP-kompatibel (keine Tailwind-CDN-Referenz enthalten)
