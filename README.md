...
@font-face {
  ...
  font-weight: 100 900;
  font-display: swap;
  src: url("/content/webentwicklung/fonts/InterVariable.woff2")
...
```js
window.addEventListener("schema:validated", (e) =>
...
window.dispatchEvent(
  new CustomEvent("particles:qualitychange", {
...
Wenn du historische Implementierungen rekonstruieren willst, kannst du frühere Commits vor dem Cleanup durchsuchen (Git Log nach _particle-config_).
