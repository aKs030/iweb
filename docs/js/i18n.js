  ...
  async getTranslations(language) {
    ...
    const translations = {
      de: {
        ...
        'about.description':
          'Leidenschaftlicher Entwickler mit Fokus auf moderne Web-Technologien.',
        ...
        'meta.description':
          'Persönliche Website von Abdulkerim mit Portfolio, Projekten und Kontaktinformationen.',
      },
      ...
      en: {
        ...
        'meta.description':
          'Personal website of Abdulkerim with portfolio, projects and contact information.',
      },
      ...
      tr: {
        ...
        'about.description':
          'Modern web teknolojilerine odaklanan tutkulu geliştirici.',
        ...
        'meta.description':
          "Portföy, projeler ve iletişim bilgileri ile Abdulkerim'in kişisel websitesi.",
      },
    };
