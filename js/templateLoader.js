...
document.addEventListener('DOMContentLoaded', () => {
  (async () => {
    try {
      ...
      if (!text.trim()) {
        throw new Error(
          'Template-Datei ist leer oder konnte nicht gelesen werden'
        );
      }
      ...
      const hiddenTemplatesContainer =
        tempDiv.querySelector('.hidden-templates');
      ...
      if (hiddenTemplatesContainer) {
        ...
        const templateCount =
          hiddenTemplatesContainer.querySelectorAll('template').length;
        console.log(
        ...
        console.warn(
          'Keine .hidden-templates Container in der geladenen Datei gefunden'
        );
      }
    } catch (error) {
