...
class WebsiteErrorHandler {
    ...
    handlePromiseError(errorData) {
        ...
        document.dispatchEvent(new CustomEvent('promiseError', {
            detail: errorData
        }));
    }
...
if (window.location.hostname === 'localhost') {
    ...
    console.log('Debug functions available: debugErrors.stats(), debugErrors.export(), debugErrors.clear(), debugErrors.trigger(type)');
}
