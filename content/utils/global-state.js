...
export function setupBackwardCompatibility() {
  ...
  Object.defineProperty(globalThis, '__threeEarthCleanup',
    createDeprecatedProxy(
      ...
      () => window.AKS.threeEarthCleanup,
      (value) => { window.AKS.threeEarthCleanup = value; }
    )
  );
  
  Object.defineProperty(globalThis, 'threeEarthSystem',
    createDeprecatedProxy(
      'globalThis.threeEarthSystem',
      'window.AKS.threeEarthSystem',
      () => window.AKS.threeEarthSystem,
      (value) => { window.AKS.threeEarthSystem = value; }
    )
  );
  
  Object.defineProperty(globalThis, '__FORCE_THREE_EARTH',
    createDeprecatedProxy(
      'globalThis.__FORCE_THREE_EARTH',
      'window.AKS.forceThreeEarth',
      () => window.AKS.forceThreeEarth,
      (value) => { window.AKS.forceThreeEarth = value; }
    )
  );
  ...
  Object.defineProperty(globalThis, 'announce',
    createDeprecatedProxy(
      ...
      'window.AKS.announce',
      () => window.AKS.announce,
      (value) => { window.AKS.announce = value; }
    )
  );
  
  Object.defineProperty(globalThis, 'SectionLoader',
    createDeprecatedProxy(
      'globalThis.SectionLoader',
      'window.AKS.SectionLoader',
      () => window.AKS.SectionLoader,
      (value) => { window.AKS.SectionLoader = value; }
    )
  );
  
  Object.defineProperty(globalThis, '__main_delegated_remove',
    createDeprecatedProxy(
      'globalThis.__main_delegated_remove',
      'window.AKS.mainDelegatedRemove',
      () => window.AKS.mainDelegatedRemove,
      (value) => { window.AKS.mainDelegatedRemove = value; }
    )
  );
  
  // Robot Companion proxy
  Object.defineProperty(globalThis, 'robotCompanionTexts',
    createDeprecatedProxy(
      'globalThis.robotCompanionTexts',
      'window.AKS.robotCompanionTexts',
      () => window.AKS.robotCompanionTexts,
      (value) => { window.AKS.robotCompanionTexts = value; }
    )
  );
  
  // YouTube integration proxies
  Object.defineProperty(globalThis, 'YOUTUBE_CHANNEL_ID',
    createDeprecatedProxy(
      'globalThis.YOUTUBE_CHANNEL_ID',
      'window.AKS.youtubeChannelId',
      () => window.AKS.youtubeChannelId,
      (value) => { window.AKS.youtubeChannelId = value; }
    )
  );
  
  Object.defineProperty(globalThis, 'YOUTUBE_CHANNEL_HANDLE',
    createDeprecatedProxy(
      'globalThis.YOUTUBE_CHANNEL_HANDLE',
      'window.AKS.youtubeChannelHandle',
      () => window.AKS.youtubeChannelHandle,
      (value) => { window.AKS.youtubeChannelHandle = value; }
    )
  );
}
