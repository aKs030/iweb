      ...
      if (hasLegacyOverlayPatch) {
        syncOverlaySignalsFromMode(
          deriveOverlayModeFromFlags({
            menuOpen: patch.menuOpen !== undefined ? patch.menuOpen : menuOpen.value,
            searchOpen: patch.searchOpen !== undefined ? patch.searchOpen : searchOpen.value,
            robotChatOpen:
              patch.robotChatOpen !== undefined ? patch.robotChatOpen : robotChatOpen.value,
          })
        );
      }
    });
