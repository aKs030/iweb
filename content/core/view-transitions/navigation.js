import { handleSamePageScroll } from "../utils/async-utils.js";
import {
  debugViewTransition,
 ...
 *
 * @param {string} href
 * @param {import('./core.js').TransitionOptions & { replace?: boolean }} [options]
...
export const createDocumentClickHandler = options => {
  return event => {
    ...
    if (!shouldHandleInternalNavigation(link, destination, captureInternalLinks)) {
      return;
    }
