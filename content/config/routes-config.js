import { OG_HOME_IMAGE_URL, OG_PROJECTS_IMAGE_URL, OG_VIDEOS_IMAGE_URL } from "./media-urls.js";
import {
  SITE_DEFAULT_ROBOTS,
...
export const ROUTES = Object.freeze({
  ...
  "/blog/": defineRoute({
    ...
    twitterDescription: "Tipps & Anleitungen zu Webdesign, SEO, Performance und Online-Marketing.",
    image: OG_HOME_IMAGE,
  }),
  "/videos/": defineRoute({
  ...
  "/contact/": defineRoute({
    ...
    description:
      "Kontaktseite für Projektanfragen, Kooperationen, Feedback und direkte Anfragen an Abdulkerim Sesli.",
    description_en:
      "Contact page for project inquiries, collaborations, feedback, and direct messages to Abdulkerim Sesli.",
    type: "ContactPage",
    robots: "index, follow",
    image: OG_HOME_IMAGE,
  }),
