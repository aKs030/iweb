...
function readRuntimeEnv(key) {
  ...
  if (runtimeWindow.ENV && Object.prototype.hasOwnProperty.call(runtimeWindow.ENV, key)) {
    return runtimeWindow.ENV[key];
  }

  if (runtimeWindow.__ENV__ && Object.prototype.hasOwnProperty.call(runtimeWindow.__ENV__, key)) {
...
function getEnv(key) {
  ...
  return isDevHostname(hostname) ? ENV_DEV[key] || ENV_DEFAULTS[key] : ENV_DEFAULTS[key];
}
