...
export const SITE_HOME_TITLE = "Portfolio für Code, 3D, AI & digitale Experimente";
...
export const SITE_HOME_TITLE_EN = "Portfolio for Code, 3D, AI & Digital Experiments";
...
export const SITE_HOME_KEYWORDS =
  "Abdulkerim Sesli, Abdul Sesli, Portfolio, Three.js, JavaScript, AI, WebGL, Fotografie, Videos, Build Notes";
export const SITE_CONTACT_EMAIL = "kontakt@abdulkerimsesli.de";
export const SITE_PERSON_ALTERNATE_NAMES = Object.freeze(["Abdülkerim Sesli", "Abdul Sesli"]);
export const SITE_PERSON_DISCOVERY_ALIASES = Object.freeze([
  ...SITE_PERSON_ALTERNATE_NAMES,
  "AKS",
  "aKs030",
]);
export const SITE_PERSON_JOB_TITLES = Object.freeze([
  "Full-Stack Web Developer",
  "Performance Engineer",
  "AI Integration Specialist",
]);
export const SITE_PERSON_SOCIAL_URLS = Object.freeze([
...
export const SITE_PERSON_KNOWS_ABOUT = Object.freeze([
  "JavaScript ES2023+",
  "Three.js",
  "Web Components",
  "Cloudflare Workers",
