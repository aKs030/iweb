...
class DayNightArtworkManager {
  ...
  async initialize() {
    try {
      // Initialisiere einfaches Theme-System falls nicht vorhanden
  ...
  /**
   * Initialisiert einfaches Theme-System falls nicht vorhanden
   */
  ...
  /**
   * Wartet auf das Theme-System (nicht mehr benötigt, aber für Kompatibilität beibehalten)
   */
  async waitForThemeSystem() {
    // Theme-System wird jetzt in initialize() erstellt, daher immer verfügbar
