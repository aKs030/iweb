...
export function setupPointerEvents(
  ...
  // Mouse Events
  eventManager.add(element, "mousedown", handlePointerDown, {
    passive: false,
    ...options,
  });
  eventManager.add(element, "mousemove", handlePointerMove, {
    passive: true,
    ...options,
  });
  eventManager.add(element, "mouseup", handlePointerUp, {
    passive: true,
    ...options,
  });
  eventManager.add(element, "mouseleave", handlePointerUp, {
    passive: true,
    ...options,
  });

  // Touch Events
  eventManager.add(element, "touchstart", handlePointerDown, {
    passive: false,
    ...options,
  });
  eventManager.add(element, "touchmove", handlePointerMove, {
    passive: true,
    ...options,
  });
  eventManager.add(element, "touchend", handlePointerUp, {
    passive: true,
    ...options,
  });
