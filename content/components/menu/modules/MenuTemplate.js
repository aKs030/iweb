...
<div class="skip-links">
  ...
  getSVGSprite() {
    return `
<svg aria-hidden="true" class="svg-sprite-hidden" xmlns="http://www.w3.org/2000/svg">
  <defs>
  ...
  getNavigation() {
    ...
    <li>
      <a href="${item.href}"${item.attrs ? ' ' + item.attrs : ''}>
        ...
        <span class="icon-fallback hidden">${item.fallback}</span>
  ...
  <ul class="site-menu__list">
    ...
    <li>
      <button type="button" class="search-trigger" aria-label="Suche öffnen" title="Spotlight-Suche (⌘K / Ctrl+K)">
        ...
        <span class="icon-fallback hidden">🔍</span>
      </button>
    </li>
  </ul>
</nav>`;
