...
export const RobotAvatar = ({ animationRefs, onClick, _mood }) => {
    ...
    >
      <svg viewBox="0 0 100 100" className="robot-svg">
        ...
        <g className="robot-eyes" ref=${eyesRef}>
          ...
          <path
            className="robot-lid"
            d="M34 36 C36 30 44 30 46 36 L46 44 C44 38 36 38 34 44 Z"
          ...
          <path
            className="robot-lid"
            d="M54 36 C56 30 64 30 66 36 L66 44 C64 38 56 38 54 44 Z"
            fill="url(#lidGradient)"
            filter="url(#lidShadow)"
          />
        </g>
        ...
        <path
          ...
          d="M30,60 L70,60 L65,90 L35,90 Z"
          fill="#0f172a"
          stroke="#40e0d0"
          strokeWidth="2"
        />
