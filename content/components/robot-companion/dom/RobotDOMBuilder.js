/**
 * Robot DOM Builder
 * Sichere DOM-Erstellung mit DOM-APIs
 * @version 1.0.0
 */
...
export class RobotDOMBuilder {
  ...
  createSVGDefs() {
    ...
    // Lid shadow filter
    const lidShadowFilter = document.createElementNS("http://www.w3.org/2000/svg", "filter");
    ...
    // Lid gradient
    const lidGradient = document.createElementNS("http://www.w3.org/2000/svg", "linearGradient");
    ...
    const flameClip = document.createElementNS("http://www.w3.org/2000/svg", "clipPath");
    flameClip.setAttribute("id", "flame-clip");
    const flameRect = document.createElementNS("http://www.w3.org/2000/svg", "rect");
  ...
  createEyes() {
    ...
    const leftLid = document.createElementNS("http://www.w3.org/2000/svg", "path");
    leftLid.classList.add("robot-lid");
    leftLid.setAttribute("d", "M34 36 C36 30 44 30 46 36 L46 44 C44 38 36 38 34 44 Z");
    ...
    const rightLid = document.createElementNS("http://www.w3.org/2000/svg", "path");
    rightLid.classList.add("robot-lid");
    rightLid.setAttribute("d", "M54 36 C56 30 64 30 66 36 L66 44 C64 38 56 38 54 44 Z");
  ...
  /**
   * Create mouth with different expressions (LED-Display style)
   * @returns {SVGGElement}
   */
  createMouth() {
    const g = document.createElementNS("http://www.w3.org/2000/svg", "g");
    ...
    const neutralMouth = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    ...
    const happyMouth = document.createElementNS("http://www.w3.org/2000/svg", "g");
    happyMouth.classList.add("mouth-happy");

    // Left segment
    const happyLeft = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    ...
    // Center segment
    const happyCenter = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    ...
    // Right segment
    const happyRight = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    ...
    const sadMouth = document.createElementNS("http://www.w3.org/2000/svg", "g");
    sadMouth.classList.add("mouth-sad");

    // Left segment (down)
    const sadLeft = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    ...
    // Center segment
    const sadCenter = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    ...
    // Right segment (down)
    const sadRight = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    ...
    const surprisedMouth = document.createElementNS("http://www.w3.org/2000/svg", "g");
    surprisedMouth.classList.add("mouth-surprised");

    // Top segment
    const surprisedTop = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    ...
    // Bottom segment
    const surprisedBottom = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    ...
    // Left segment
    const surprisedLeft = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    ...
    // Right segment
    const surprisedRight = document.createElementNS("http://www.w3.org/2000/svg", "rect");
    ...
    surprisedMouth.append(surprisedTop, surprisedBottom, surprisedLeft, surprisedRight);

    g.append(neutralMouth, happyMouth, sadMouth, surprisedMouth);
  ...
  createMagnifyingGlass() {
    ...
    const localDefs = document.createElementNS("http://www.w3.org/2000/svg", "defs");

    // 1. Handle Gradient (Cylindrical Black/Dark Grey)
    const handleGradientId = "handleGradient";
    const handleGradient = document.createElementNS("http://www.w3.org/2000/svg", "linearGradient");
    ...
    // Center - Ultra clear
    const stopRG1 = document.createElementNS("http://www.w3.org/2000/svg", "stop");
    ...
    const stopRG2 = document.createElementNS("http://www.w3.org/2000/svg", "stop");
    ...
    localDefs.append(handleGradient, chromeGradient, realGlassGradient, shadowFilter);
    g.append(localDefs);
    ...
    const handleCap = document.createElementNS("http://www.w3.org/2000/svg", "circle");
    ...
    const specular = document.createElementNS("http://www.w3.org/2000/svg", "ellipse");
    ...
    const refraction = document.createElementNS("http://www.w3.org/2000/svg", "path");
    refraction.setAttribute("d", `M${cx - 8},${cy + 4} Q${cx},${cy + 10} ${cx + 8},${cy + 4}`);
    ...
    g.append(handleRect, handleCap, connector, rim, lens, glare, specular, refraction);
