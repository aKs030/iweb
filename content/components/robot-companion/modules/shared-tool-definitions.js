...
export const SHARED_ROBOT_TOOL_DEFINITIONS = Object.freeze([
  ...
  },
  {
    ...
    description: "Scrolle zu einem Abschnitt (header, footer, contact, hero, projects, skills).",
    parameters: {
      type: "object",
      properties: {
        section: { type: "string" },
  ...
  {
    name: "focusSearch",
    description: "Fokussiere die Suche. Optional kann ein Suchbegriff gesetzt werden.",
    parameters: {
      type: "object",
      properties: {
        query: { type: "string" },
  ...
  },
  {
    ...
    description: "Lösche den lokalen Chatverlauf (nur auf Nutzerwunsch verwenden).",
    parameters: {
      type: "object",
      properties: {},
    },
