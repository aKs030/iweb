...
/**
 * @param {string} name
 * @param {Partial<RobotToolDefinition>} [overrides]
 * @returns {RobotToolDefinition}
 */
...
const ROBOT_TOOL_DEFINITIONS = /** @type {readonly RobotToolDefinition[]} */ (
  Object.freeze([
    ...
    },
    {
      ...
      description: "Öffne eine Kalender-Erinnerung (Google Calendar) mit vorausgefüllten Daten.",
      parameters: {
        type: "object",
        properties: {
          title: { type: "string" },
