...
function hasRobotCompanion() {
  ...
  return Boolean(getRobotAvatarButton() || document.getElementById("robot-companion-container"));
}
...
const TOOL_AVAILABILITY_CHECKS = {
  ...
  openImageUpload: () => Boolean(getRobotImageUploadInput() || getRobotAvatarButton()),
