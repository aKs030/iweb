export class RobotAnimation {
  ...
  updateStartAnimation() {
    ...
    if (this.startAnimation.phase === 'approach') {
      ...
      if (this.robot.dom.flame) {
        ...
        this.robot.dom.flame.style.transform = `scale(${1 + flameIntensity * 0.3})`
  ...
  updatePatrol() {
    ...
    const approachingLimit =
      (this.patrol.direction > 0 && this.patrol.x + 10 >= maxLeft - 20) || (this.patrol.direction < 0 && this.patrol.x - 10 <= 20)
    ...
    if (this.robot.dom.particles) {
      this.robot.dom.particles.style.opacity = dashActive || (this.startAnimation && this.startAnimation.active) ? '0.9' : '0.5'
    }
