...
export const ROUTES = {
  default: {
    ...
    type: 'ProfilePage',
    image: `${BASE_URL}/assets/img/og/og-home-800.webp`,
    imageWebp: `${BASE_URL}/assets/img/og/og-home-800.webp`,
  },
  '/projekte/': {
    ...
    type: 'CollectionPage',
    image: `${BASE_URL}/assets/img/og/og-projekte-800.webp`,
  },
  '/blog/': {
  ...
  '/videos/': {
    ...
    type: 'CollectionPage',
    image: `${BASE_URL}/assets/img/og/og-videos-800.webp`,
  },
  '/gallery/': {
