...
const buildProjectsOverviewPath = state => `${PROJECTS_HOME_PATH}${buildBrowseSearch(state)}`;
...
const App = () => {
  ...
  useEffect(() => {
    ...
    const projectsListId = "https://www.abdulkerimsesli.de/projekte/#projects-list";
