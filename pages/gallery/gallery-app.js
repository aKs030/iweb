      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            {
              className: 'flex gap-2 bg-white/10 backdrop-blur-sm rounded-xl p-1 border border-white/20'
            },
            React.createElement(
              'button',
              {
    ...
    React.createElement(
      ...
      filteredPhotos.map((photo, index) =>
        React.createElement(
          ...
          React.createElement(
            'div',
            {className: 'aspect-[4/3] bg-slate-800/50 backdrop-blur-sm relative'},
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'div',
            {
              className: 'px-4 py-3 text-white font-semibold min-w-[80px] text-center bg-white/5 rounded-xl'
            },
            `${Math.round(zoom * 100)}%`
          ),
          React.createElement(
