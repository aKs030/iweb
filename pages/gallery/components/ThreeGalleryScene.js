...
import { X_Icon } from "#components/icons/icons.js";
...
export const ThreeGalleryScene = ({ items }) => {
  ...
  useEffect(() => {
    ...
    systemRef.current = new Gallery3DSystem(containerRef.current, items, item => {
            ...
            h(
              ...
              h(
                ...
                selectedItem.orientation &&
                  h("span", { className: "gallery-lightbox__meta-pill" }, selectedItem.orientation),
