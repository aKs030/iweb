...
const Heart = createIcon(React.createElement(React.Fragment, null,
...
const X_Icon = createIcon(React.createElement(React.Fragment, null,
  React.createElement('line', { x1: '18', y1: '6', x2: '6', y2: '18' }),
  React.createElement('line', { x1: '6', y1: '6', x2: '18', y2: '18' })
));

const ChevronLeft = createIcon(React.createElement(React.Fragment, null,
  React.createElement('polyline', { points: '15 18 9 12 15 6' })
));

const ChevronRight = createIcon(React.createElement(React.Fragment, null,
  React.createElement('polyline', { points: '9 18 15 12 9 6' })
));

const ZoomIn = createIcon(React.createElement(React.Fragment, null,
...
const ZoomOut = createIcon(React.createElement(React.Fragment, null,
  React.createElement('circle', { cx: '11', cy: '11', r: '8' }),
  React.createElement('line', { x1: '21', y1: '21', x2: '16.65', y2: '16.65' }),
  React.createElement('line', { x1: '8', y1: '11', x2: '14', y2: '11' })
));

const Download = createIcon(React.createElement(React.Fragment, null,
  React.createElement('path', { d: 'M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4' }),
  React.createElement('polyline', { points: '7 10 12 15 17 10' }),
  React.createElement('line', { x1: '12', y1: '15', x2: '12', y2: '3' })
));

const Grid2x2 = createIcon(React.createElement(React.Fragment, null,
...
const Grid3x3 = createIcon(React.createElement(React.Fragment, null,
...
const Search = createIcon(React.createElement(React.Fragment, null,
  React.createElement('circle', { cx: '11', cy: '11', r: '8' }),
  React.createElement('line', { x1: '21', y1: '21', x2: '16.65', y2: '16.65' })
));

const Share2 = createIcon(React.createElement(React.Fragment, null,
...
const Play = createIcon(React.createElement(React.Fragment, null,
  React.createElement('polygon', { points: '5 3 19 12 5 21 5 3' })
));

const Pause = createIcon(React.createElement(React.Fragment, null,
  React.createElement('rect', { x: '6', y: '4', width: '4', height: '16' }),
  React.createElement('rect', { x: '14', y: '4', width: '4', height: '16' })
));

const Info = createIcon(React.createElement(React.Fragment, null,
...
const PhotoGallery = () => {
  ...
  return React.createElement('div', { className: 'min-h-screen p-4 sm:p-8' },
    React.createElement('div', { className: 'max-w-7xl mx-auto mb-8' },
      ...
      React.createElement('div', { className: 'flex flex-col lg:flex-row justify-between items-center gap-4 mb-6' },
        ...
        React.createElement('div', { className: 'flex gap-3 items-center' },
          React.createElement('select', {
            ...
            React.createElement('option', { value: 'popular', className: 'bg-slate-900' }, 'Beliebt')
          ),
          React.createElement('div', { className: 'flex gap-2 bg-white/10 backdrop-blur-sm rounded-xl p-1 border border-white/20' },
            React.createElement('button', {
      ...
      React.createElement('div', { className: 'text-center text-indigo-300 mb-6' },
        `${filteredPhotos.length} ${filteredPhotos.length === 1 ? 'Foto' : 'Fotos'} gefunden`
      )
    ),
    React.createElement('div', { className: `max-w-7xl mx-auto grid ${gridCols} gap-6` },
      filteredPhotos.map((photo, index) =>
        React.createElement('div', {
          ...
          React.createElement('div', { className: 'aspect-[4/3] bg-slate-800/50 backdrop-blur-sm relative' },
            ...
            React.createElement('div', { className: 'absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-60' })
          ),
          React.createElement('div', { className: 'absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-between p-6' },
            React.createElement('div', { className: 'flex justify-between items-start' },
              React.createElement('span', { className: 'px-3 py-1 bg-white/20 backdrop-blur-md rounded-full text-white text-xs font-medium border border-white/30' },
                photo.category
              ),
              React.createElement('button', {
            ...
            React.createElement('div', null,
              React.createElement('h3', { className: 'text-white text-xl font-bold mb-2' }, photo.title),
              React.createElement('div', { className: 'flex items-center gap-3 text-indigo-200 text-sm' },
    ...
    selectedImage && React.createElement('div', {
      ...
      React.createElement('div', { className: 'absolute top-0 left-0 right-0 p-6 bg-gradient-to-b from-black/80 to-transparent z-10' },
        React.createElement('div', { className: 'max-w-7xl mx-auto flex justify-between items-center' },
          React.createElement('div', { className: 'text-white' },
            React.createElement('h2', { className: 'text-2xl font-bold mb-1' }, selectedImage.title),
            React.createElement('p', { className: 'text-indigo-300' }, `${selectedImage.location} • ${new Date(selectedImage.date).toLocaleDateString('de-DE')}`)
          ),
      ...
      showInfo && React.createElement('div', { className: 'absolute top-24 right-6 w-80 bg-black/90 backdrop-blur-xl rounded-2xl p-6 border border-white/10 z-10' },
        ...
        React.createElement('div', { className: 'space-y-3 text-sm' },
          React.createElement('div', { className: 'flex justify-between' },
            React.createElement('span', { className: 'text-indigo-300' }, 'Kamera:'),
            React.createElement('span', { className: 'text-white font-medium' }, selectedImage.camera)
          ),
          React.createElement('div', { className: 'flex justify-between' },
            React.createElement('span', { className: 'text-indigo-300' }, 'Blende:'),
            React.createElement('span', { className: 'text-white font-medium' }, selectedImage.aperture)
          ),
          React.createElement('div', { className: 'flex justify-between' },
            React.createElement('span', { className: 'text-indigo-300' }, 'ISO:'),
            React.createElement('span', { className: 'text-white font-medium' }, selectedImage.iso)
          ),
          React.createElement('div', { className: 'flex justify-between' },
            React.createElement('span', { className: 'text-indigo-300' }, 'Ort:'),
            React.createElement('span', { className: 'text-white font-medium' }, selectedImage.location)
          ),
          React.createElement('div', { className: 'flex justify-between' },
          ...
          React.createElement('div', { className: 'pt-3 border-t border-white/10' },
      ...
      React.createElement('button', {
        ...
        className: 'absolute left-6 top-1/2 -translate-y-1/2 p-4 bg-white/10 hover:bg-white/20 rounded-full transition-all backdrop-blur-md z-10 group'
      },
      ...
      React.createElement('button', {
        ...
        className: 'absolute right-6 top-1/2 -translate-y-1/2 p-4 bg-white/10 hover:bg-white/20 rounded-full transition-all backdrop-blur-md z-10 group'
      },
        ChevronRight({ size: 32, className: 'text-white group-hover:scale-110 transition-transform' })
      ),
      React.createElement('div', { className: 'absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-3 bg-black/80 backdrop-blur-xl rounded-2xl p-3 border border-white/10' },
        React.createElement('button', {
          onClick: (e) => {
            e.stopPropagation();
            handleZoom(-0.25);
        ...
        React.createElement('div', { className: 'px-4 py-3 text-white font-semibold min-w-[80px] text-center bg-white/5 rounded-xl' },
          `${Math.round(zoom * 100)}%`
        ),
        React.createElement('button', {
          onClick: (e) => {
